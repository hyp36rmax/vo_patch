...
CHECKS = [
    ...
    ('tanita', 'native Tanita helper and mapping',
     [PY, 'tools/tanitatest.py'], False, False),
    ('disc', 'the disc reader, on images built for the test',
     [PY, 'tools/disctest.py'], False, False),
    ('controller', 'profile dispatch, ordering and controller input',
     [PY, 'tools/controllertest.py'], False, False),
    ('raphnet', 'native Raphnet decoding, claims and game integration',
    ...
    ('lint', 'pyflakes',
     [PY, '-m', 'pyflakes', 'v-on-patcher.py', 'asm/build.py', 'asm/layout.py',
      'asm/padtables.py', 'asm/dialogs.py', 'net/build.py', 'input/build.py',
      'tools/tanitatest.py', 'tools/customtest.py', 'tools/raphnettest.py',
